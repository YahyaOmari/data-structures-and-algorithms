...
const addValues = (arr) => {
  // Solution code here...
  // const test = (total, currentValue) => total + currentValue;
...
const addPurchases = (arr) => {
  // Solution code here...
  let total = arr.reduce((current, value) => {
    current += value.purchasePrice;
    return current;
  }, 0 );
  return total;
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce((array, nameOb) =>{
    array.push(nameOb.name);
    return array;
  }, []);
};
